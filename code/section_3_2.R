...
validate_model <- function(model, population_ps, population_counts,sample_truth, popn_truth){
...
model_score_full <- validate_model(full_model_fit, popn_ps, popn_ps$Nj, sample_truth = popn_predict_e, popn_truth = popn_ps$y_count/popn_ps$Nj)
